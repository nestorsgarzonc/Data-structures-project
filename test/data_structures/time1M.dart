...
void main() {
  ...
  group("Tomas de tiempo para 1M de datos", () {
    test("PushBack1M", () {
      ...
      print(
          'PushBack para 1M de datos en ${stopwatch.elapsedMilliseconds} milisegundos');
      expect(true, true);
    });
    test("PopBack", () {
      Stopwatch stopwatch = new Stopwatch()..start();
      lista.popBack();
      print(
          'PopBack en una lista de 1M de datos en ${stopwatch.elapsedMilliseconds} milisegundos');
